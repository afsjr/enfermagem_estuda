# Plano de Exploração — enfermagem-estuda

> Criado pelo Reversa em 2026-07-05
...
- [✅] **Arqueólogo** — Análise do módulo `chat` (Tutor IA)
- [✅] **Arqueólogo** — Análise do módulo `dashboard` (Painel de Estudos)
- [✅] **Arqueólogo** — Análise do módulo `calculator` (Calculadora Farmacológica)
- [✅] **Arqueólogo** — Análise do módulo `quiz` (Simulador de Quiz)
- [✅] **Arqueólogo** — Análise do módulo `onboarding` (Perfil do Aluno)
- [✅] **Arqueólogo** — Análise do módulo `notes` (Bloco de Notas)
- [✅] **Arqueólogo** — Análise do módulo `gamification` (XP e Níveis)
- [✅] **Arqueólogo** — Análise do módulo `telemetry` (Telemetria Anônima)
- [✅] **Arqueólogo** — Análise do módulo `security` (Segurança/Sanitização)
- [✅] **Arqueólogo** — Análise do módulo `supabase-proxy` (Edge Function)
